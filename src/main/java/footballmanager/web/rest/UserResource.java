...
import footballmanager.config.Constants;
import footballmanager.domain.User;
import footballmanager.repository.UserRepository;
import footballmanager.security.AuthoritiesConstants;
import footballmanager.service.MailService;
import footballmanager.service.UserService;
import footballmanager.service.dto.AdminUserDTO;
import footballmanager.web.rest.errors.BadRequestAlertException;
import footballmanager.web.rest.errors.EmailAlreadyUsedException;
import footballmanager.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link footballmanager.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    @Value("${jhipster.clientApp.name:footballManager}")
